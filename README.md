...
## Output screen shots of proteus  :
 <img width="843" height="528" alt="image" src="https://github.com/user-attachments/assets/967fbc68-5860-4807-a5d7-e3a0d46b1032" />

<img width="845" height="531" alt="image" src="https://github.com/user-attachments/assets/9c442cec-0c61-4249-be7d-0dcc4c7114c5" />

<img width="834" height="538" alt="image" src="https://github.com/user-attachments/assets/9cb7ed82-e8df-4667-ac34-cebd6913d555" />

<img width="845" height="535" alt="image" src="https://github.com/user-attachments/assets/d11448e4-67d3-4552-a818-654d935844e8" />

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 

 <img width="778" height="603" alt="image" src="https://github.com/user-attachments/assets/2e55581e-2206-4e8f-af80-fc5b754c2d59" />
...
TON = 5 × 0.1 = 0.5ms
TOFF = 5 × 0.1 = 0.5ms
TOTAL TIME = TON + TOFF = 0.5 + 0.5 = 1.0ms
FREQUENCY = 1 / (TOTAL TIME) = 1 / 1.0 = 1 kHz
DUTY RATIO = TON / (TON + TOFF) = 0.5 / 1.0 = 0.5 = 50%
```
```
FOR PULSE AT 7000
...
TON = 7 × 0.1 = 0.7ms
TOFF = 3 × 0.1 = 0.3ms
TOTAL TIME = TON + TOFF = 0.7 + 0.3 = 1.0ms
FREQUENCY = 1 / (TOTAL TIME) = 1 / 1.0 = 1 kHz
DUTY RATIO = TON / (TON + TOFF) = 0.7 / 1.0 = 0.7 = 70%
```
```
...
TON = 9 × 0.1 = 0.9ms
TOFF = 1 × 0.1 = 0.1ms
TOTAL TIME = TON + TOFF = 0.9 + 0.1 = 1.0ms
FREQUENCY = 1 / (TOTAL TIME) = 1 / 1.0 = 1 kHz
